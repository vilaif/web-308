...
<head>
    <title>Invoice #<?= esc($transactions['transaction_code']) ?></title>
...
<body>
    <div class="invoice-container">
        <div class="header">
            <img src="<?= base_url('uploads/logo/' . ($title['image'] ?? 'default-logo.png')) ?>" alt="Logo Perusahaan"
                style="width: 120px;">
        ...
        <p><strong>Tanggal:</strong> <?= date('d F Y', strtotime($transactions['created_at'])) ?></p>
        <p><strong>Kode Transaksi:</strong> <?= esc($transactions['transaction_code']) ?></p>
        <p><strong>Penerima:</strong> <?= esc($transactions['recipient_name']) ?></p>
        <p><strong>Username:</strong> <?= esc($transactions['username']) ?></p>
